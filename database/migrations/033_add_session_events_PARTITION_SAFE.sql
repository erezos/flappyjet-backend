-- ============================================================================
-- MIGRATION: 033_add_session_events_PARTITION_SAFE.sql
-- Purpose: Add session tracking events to valid_event_type constraint (partition-safe)
-- Date: 2025-12-23
-- Author: FlappyJet Analytics Team
-- 
-- FIX: For partitioned tables, we need to handle constraint addition carefully
-- ============================================================================

-- Step 1: Drop the existing constraint from parent table
...
-- Step 2: Add constraint to parent table
-- PostgreSQL will automatically propagate to all partitions
-- But it validates ALL existing data in ALL partitions

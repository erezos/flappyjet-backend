-- ============================================================================
-- Migration 019: Add tournament_abandoned event (Dec 2025 hotfix)
-- ============================================================================
-- Purpose:
--   Include tournament_abandoned in the valid_event_type constraint to match
--   new Flutter event payloads and backend schema validation.
--
-- Notes:
--   - Extends the list from migration 018 by adding tournament_abandoned.
...
-- Add updated constraint with tournament_abandoned
...
-- (Optional) add indexes if needed; omitted to keep migration minimal.

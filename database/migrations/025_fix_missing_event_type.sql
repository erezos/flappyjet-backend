-- ============================================================================
-- FIX: Add ALL event types found in codebase to constraint
-- This is the comprehensive whitelist based on actual code analysis
-- ============================================================================

ALTER TABLE events_partitioned DROP CONSTRAINT IF EXISTS valid_event_type;

ALTER TABLE events_partitioned ADD CONSTRAINT valid_event_type CHECK (
  event_type IN (
...
SELECT 'Constraint updated: Comprehensive whitelist with 90+ event types' AS status;

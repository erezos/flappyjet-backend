-- ============================================================================
-- MIGRATION: 031_add_missing_tournament_events.sql
-- Purpose: Add missing tournament event types to valid_event_type constraint
-- Date: 2025-12-23
-- Author: FlappyJet Analytics Team
-- 
-- Missing events found in production logs:
-- - tournament_round_completed
-- - tournament_round_advanced
-- - tournament_round_failed (found in codebase)
-- ============================================================================
...
-- Recreate constraint with missing tournament events
ALTER TABLE events ADD CONSTRAINT valid_event_type CHECK (
  event_type IN (
    ...
    -- Tournament Events (15 events) ✅ UPDATED: Added missing events
    'tournament_entered', 'tournament_round_started', 'tournament_round_completed', -- ✅ NEW
    'tournament_round_advanced', 'tournament_round_failed', -- ✅ NEW
...
BEGIN
  ...
  RAISE NOTICE '✅ Migration 031_add_missing_tournament_events.sql completed successfully';
  RAISE NOTICE '📊 Added missing tournament events: tournament_round_completed, tournament_round_advanced, tournament_round_failed';
END $$;
